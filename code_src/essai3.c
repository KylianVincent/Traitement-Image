...
unsigned char** inverse( unsigned char** sortie,  double** entree, int nl, int nc) { int i,j;
...
//TEST
//	fftshift(im3,im4,im5,im6,nl,nc);
//  im3=imuchar2double(inverse(NULL,im3,nl,nc),nl,nc);
//	fftshift(im5,im6,im3,im4,nl,nc);
  im5=imuchar2double(inverse(NULL,im5,nl,nc),nl,nc);
